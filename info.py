...
BOT_TOKEN = environ.get('BOT_TOKEN', '6569837990:AAEMpS34ekU9Kf00_i68miWiAcniIo8oAkw')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001866466593').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/rgsearchmovie')
